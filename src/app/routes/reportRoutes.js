...
module.exports = function (app) {
  app.all(
    [
      `${BASE_REPORT_URL}/update/:reportId`,
      `${BASE_REPORT_URL}/publish/:reportId`,
      `${BASE_REPORT_URL}/publish/:reportId/:hash`,
      `${BASE_REPORT_URL}/retire/:reportId`,
      `${BASE_REPORT_URL}/retire/:reportId/:hash`,
    ],
    ...
    proxy(REPORT_SERVICE_URL, {
      ...
      proxyReqOptDecorator:
        proxyUtils.decorateRequestHeaders(REPORT_SERVICE_URL),
  ...
  app.all(
    [`${BASE_REPORT_URL}/list`, `${BASE_REPORT_URL}/get/:reportId`],
    proxyUtils.verifyToken(),
  ...
  app.all(
    ...
    proxy(CONTENT_URL, {
      ...
      proxyReqPathResolver: function (req) {
        ...
        let query = require("url").parse(req.url).query;
        if (query) {
          return require("url").parse(CONTENT_URL + urlParam + "?" + query)
            .path;
        } else {
  ...
  app.all(
    [`${BASE_REPORT_URL}/get/:reportId/:hash`, `${BASE_REPORT_URL}/summary/*`],
    proxyUtils.verifyToken(),
    reportHelper.validateRoles(["REPORT_VIEWER", "REPORT_ADMIN"]),
    proxy(REPORT_SERVICE_URL, {
      limit: reqDataLimitOfContentUpload,
  ...
  app.get(
    "/course-reports/metadata",
    proxyUtils.verifyToken(),
    reportHelper.validateRoles([
      "CONTENT_CREATOR",
      "REPORT_VIEWER",
      "REPORT_ADMIN",
      "ORG_ADMIN",
  ...
  app.get(
    `${BASE_REPORT_URL}/dataset/get/:datasetId`,
    proxyUtils.verifyToken(),
    reportHelper.validateRoles(["REPORT_ADMIN"]),
