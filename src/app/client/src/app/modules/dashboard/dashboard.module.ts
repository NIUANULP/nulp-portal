...
import {
  ...
  CourseCategoryWiseComponent,
  ContentCreationStaticsComponent,
...
export const csCourseServiceFactory = (
  csLibInitializerService: CsLibInitializerService
) => {
...
@NgModule({
  ...
  declarations: [
    ...
    ContentLeaderboardComponent,
    UserUploadComponent,
    CourseContentLeaderboardComponent,
    FileuploadComponent,
    CertificateTemplateUploadComponent,
    ReportsComponent,
    OrganizationReportComponent,
    ContentReportComponent,
    ContentCategoryWiseComponent,
  ...
  providers: [
    ...
    [
      {
        provide: "CS_COURSE_SERVICE",
        useFactory: csCourseServiceFactory,
        deps: [CsLibInitializerService],
      },
    ],
  ],
})
