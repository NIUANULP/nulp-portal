...
import { LearnathonLocationComponent } from './user-location.component';
import {
  ResourceService,
  ToasterService,
  ConfigService,
...
describe('LearnathonLocationComponent', () => {
  let component: LearnathonLocationComponent;
  let fixture: ComponentFixture<LearnathonLocationComponent>;
  let configService;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [LearnathonLocationComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(LearnathonLocationComponent);
