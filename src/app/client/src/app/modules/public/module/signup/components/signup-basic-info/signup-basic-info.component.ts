...
export class SignupBasicInfoComponent implements OnInit {
  ...
  instance: '';
  userTypes: string[] = ['State Governments / Parastatal Bodies', 'Urban Local Bodies / Special Purpose Vehicles', 'Academia and Research Organisations', 'Multilateral / Bilateral Agencies', 'Industries','Any Other Government Entities'];
 ...
 ngOnInit(): void {
  ...
  onUserTypeChange(event: Event): void {
    ...
    this.isOtherUserType = selectedValue === 'other';
    if (!this.isOtherUserType) {
