...
@Component({
  selector: 'app-learnathon-language',
  templateUrl: './learnathon-language.component.html',
  styleUrls: ['./learnathon-language.component.scss']
})
export class LearnathonLanguageComponent implements OnInit {
