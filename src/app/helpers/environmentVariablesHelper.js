...
let envVariables = {
  ...
  APPID:
    process.env.sunbird_environment +
    "." +
    process.env.sunbird_instance +
    ".portal",
  ...
  LEARNER_URL:
    env.sunbird_learner_player_url || "https://staging.open-sunbird.org/api/",
  CONTENT_URL:
    env.sunbird_content_player_url || "https://staging.open-sunbird.org/api/",
  CONTENT_PROXY_URL:
    env.sunbird_content_proxy_url || "https://staging.open-sunbird.org",
  PORTAL_REALM: env.sunbird_portal_realm || "sunbird",
  PORTAL_AUTH_SERVER_URL:
    env.sunbird_portal_auth_server_url ||
    "https://staging.open-sunbird.org/auth",
  PORTAL_AUTH_SERVER_CLIENT: env.sunbird_portal_auth_server_client || "portal",
  PORTAL_API_AUTH_TOKEN: env.sunbird_api_auth_token,
  PORTAL_ECHO_API_URL:
    env.sunbird_echo_api_url || "https://staging.open-sunbird.org/api/echo/",
  CONFIG_URL:
    env.sunbird_config_service_url ||
    "https://staging.open-sunbird.org/api/config/",
  EKSTEP_ENV: env.ekstep_env || "qa",
  DEVICE_REGISTER_API:
    process.env.sunbird_device_register_api ||
    "https://api.open-sunbird.org/v3/device/register/",
  DEVICE_PROFILE_API:
    process.env.sunbird_device_profile_api ||
    "https://staging.open-sunbird.org/api/v3/device/profile/",
  ...
  sunbird_extcont_whitelisted_domains:
    env.sunbird_extcont_whitelisted_domains || "youtube.com,youtu.be",
  sunbird_explore_button_visibility:
    env.sunbird_explore_button_visibility || "true",
  sunbird_help_link_visibility: env.sunbird_help_link_visibility || "false",
  sunbird_portal_user_upload_ref_link:
    env.sunbird_portal_user_upload_ref_link ||
    "http://www.sunbird.org/features-documentation/register_user",
  ...
  CRYPTO_ENCRYPTION_KEY:
    env.crypto_encryption_key || "030702bc8696b8ee2aa71b9f13e4251e",
  CRYPTO_ENCRYPTION_KEY_EXTERNAL:
    env.crypto_encryption_key_external || "030702me8696b8ee2aa71x9n13l4251e",
  LOG_FINGERPRINT_DETAILS: env.sunbird_log_fingerprint_details || "true",
  REPORT_SERVICE_URL:
    env.sunbird_report_service_url ||
    "https://staging.open-sunbird.org/api/data/v1/report-service",
  SUNBIRD_PORTAL_BASE_URL: env.sunbird_portal_base_url,
  sunbird_device_api:
    env.sunbird_device_api || "https://staging.ntp.net.in/api/",
  sunbird_portal_slugForProminentFilter:
    env.sunbird_portal_slugForProminentFilter,
  sunbird_super_admin_slug: env.sunbird_super_admin_slug || "sunbird",
  sunbird_kid_public_key_base_path:
    env.sunbird_kid_public_key_base_path || "/keys/",
  reportsListVersion: env.reportsListVersion || "v1",
  sunbird_data_product_service:
    env.sunbird_data_product_service || "https://staging.ntp.net.in/",
  ML_SERVICE_BASE_URL:
    env.ml_survey_url || "https://survey.preprod.ntp.net.in/staging",
  ...
  sunbird_portal_updateLoginTimeEnabled:
    env.sunbird_portal_updateLoginTimeEnabled || false,
  sunbird_api_request_timeout: env.sunbird_api_request_timeout
    ? parseInt(env.sunbird_api_request_timeout)
    : 60 * 1000,
  sunbird_session_ttl: env.sunbird_session_ttl
    ? parseInt(env.sunbird_session_ttl)
    : 24 * 60 * 60 * 1000,

  // Telemetry Configuration
  PORTAL_TELEMETRY_PACKET_SIZE: env.sunbird_telemetry_packet_size || 1000,
  TELEMETRY_SERVICE_LOCAL_URL:
    env.sunbird_telemetry_service_local_url || "http://telemetry-service:9001/",
  ...
  PORTAL_AUTOCREATE_TRAMPOLINE_USER:
    env.sunbird_autocreate_trampoline_user || "true",
  PORTAL_MERGE_AUTH_SERVER_URL:
    env.sunbird_portal_merge_auth_server_url ||
    "https://merge.staging.open-sunbird.org/auth",
  ...
  PORTAL_CASSANDRA_CONSISTENCY_LEVEL:
    env.sunbird_cassandra_consistency_level || "one",
  PORTAL_CASSANDRA_REPLICATION_STRATEGY:
    env.sunbird_cassandra_replication_strategy ||
    '{"class":"SimpleStrategy","replication_factor":1}',
  sunbird_azure_report_container_name:
    env.sunbird_azure_report_container_name || "reports",
  sunbird_azure_account_name: env.sunbird_azure_account_name,
  sunbird_azure_account_key: env.sunbird_azure_account_key,
  desktop_azure_crash_container_name:
    env.desktop_crash_container_name || "desktopappcrashlogs",
  ...
  sunbird_azure_resourceBundle_container_name:
    env.sunbird_azure_resourceBundle_container_name || "label",

  // generic editor question set and coleections children contents limit
  SUNBIRD_QUESTIONSET_CHILDREN_LIMIT:
    env.sunbird_questionset_children_limit || 500,
  SUNBIRD_COLLECTION_CHILDREN_LIMIT:
    env.sunbird_collection_children_limit || 1200,

  // Default Language Configuration
  sunbird_default_language: env.sunbird_portal_default_language || "en",
  sunbird_primary_bundle_language:
    env.sunbird_portal_primary_bundle_language || "en",

  // Service(s) Base URL(s)
  learner_Service_Local_BaseUrl:
    env.sunbird_learner_service_local_base_url || "http://learner-service:9000",
  content_Service_Local_BaseUrl:
    env.sunbird_content_service_local_base_url || "http://content-service:5000",
  CONTENT_SERVICE_UPSTREAM_URL:
    env.sunbird_content_service_upstream_url || "http://localhost:5000/",
  LEARNER_SERVICE_UPSTREAM_URL:
    env.sunbird_learner_service_upstream_url || "http://localhost:9000/",
  DATASERVICE_URL:
    env.sunbird_dataservice_url || "https://staging.open-sunbird.org/api/",
  PORTAL_EXT_PLUGIN_URL:
    process.env.sunbird_ext_plugin_url || "http://player_player:3000/plugin/",
  sunbird_data_product_service:
    env.sunbird_data_product_service || "https://staging.ntp.net.in/",

  // Health Checks Configuration
  sunbird_portal_health_check_enabled:
    env.sunbird_health_check_enable || "true",
  ...
  // API Base URL
  api_base_url: env.api_base_url || "https://nulp.niua.org",
  ...
  sunbird_portal_offline_supported_languages:
    env.sunbird_portal_offline_supported_languages ||
    "English, Assamese, Bengali, Gujarati, Hindi, Kannada, Malayalam, Marathi, Oriya, Punjabi, Tamil, Telugu, Urdu",
  sunbird_portal_offline_app_release_date:
    env.sunbird_portal_offline_app_release_date,
  sunbird_portal_offline_app_version: env.sunbird_portal_offline_app_version,
  sunbird_portal_offline_app_download_url:
    env.sunbird_portal_offline_app_download_url,
  ...
  PHRASE_APP: {
    ...
    phrase_locale: env.phrase_locale || [
      "en-IN",
      "bn-IN",
      "hi-IN",
      "kn-IN",
  ...
  KONG_DEVICE_REGISTER_ANONYMOUS_TOKEN:
    env.sunbird_kong_device_register_anonymous || "false",
  KONG_DEVICE_REGISTER_AUTH_TOKEN: env.sunbird_kong_device_register_token,
  sunbird_anonymous_session_ttl: env.sunbird_anonymous_session_ttl
    ? parseInt(env.sunbird_anonymous_session_ttl)
    : 10 * 60 * 1000,
  sunbird_default_device_token: env.sunbird_default_device_token || "",
  // Kong endpoints
  sunbird_anonymous_device_register_api:
    env.sunbird_anonymous_device_register_api || "",
  sunbird_loggedin_device_register_api:
    env.sunbird_loggedin_device_register_api || "",
  ...
  sunbird_portal_uci_bot_phone_number:
    env.sunbird_portal_uci_bot_phone_number || "",
};

envVariables.PORTAL_CASSANDRA_URLS =
  env.sunbird_cassandra_urls && env.sunbird_cassandra_urls !== ""
    ? env.sunbird_cassandra_urls.split(",")
    : ["localhost"];
