...
const API_LIST = {
  URL: {
    ...
    "/content/course/v1/content/state/read": {
      ...
      ROLE_CHECK: [ROLE.PUBLIC],
      OWNER_CHECK: {
        checks: [{ entity: "__session__userId", params: [] }],
      },
    },
    ...
    "/learner/course/v1/user/enrollment/list/:userId": {
      ...
      ROLE_CHECK: [ROLE.ALL],
      OWNER_CHECK: {
        checks: [{ entity: "__urlparams__userId", params: [], key: "userId" }],
      },
    },
    ...
    "/learner/user/v1/feed/delete": {
      ...
      OWNER_CHECK: {
        checks: [
          {
            entity: "__session__userId",
            params: [],
            key: "body.request.userId",
          },
        ],
      },
    },
    ...
    "/learner/user/v3/search": {
      description:
        "API to search for user (Admin user Search) with new roles array structure",
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.PUBLIC],
    },
        ...
        checks: [
          {
            entity: "__session__userId",
            params: [],
            key: "body.request.filters.userId",
          },
        ],
      },
    },
    ...
    "/plugin/review/comment/v1/read/comment": {
      description:
        "API which provides stage level comments provided by reviewers",
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [
        ROLE.CONTENT_CREATOR,
        ROLE.COURSE_CREATOR,
    ...
    "/action/data/v1/page/assemble": {
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.COURSE_CREATOR, ROLE.BOOK_CREATOR],
    },
    ...
    "/action/content/v3/copy/:do_id": {
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.ORG_ADMIN, ROLE.BOOK_CREATOR],
    },
    "/signup": {
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.ANONYMOUS],
    ...
    "/votingTool/voteCount": {
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.ALL, ROLE.PUBLIC],
    },
    "/votingTool/voteDelete": {
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.ALL, ROLE.PUBLIC],
    },
    "/v1/votingTool/system/config/getdetails": {
      checksNeeded: ["ROLE_CHECK"],
      ROLE_CHECK: [ROLE.ALL, ROLE.PUBLIC],
    },
  },
